...
class GenericMemberIterator : public std::iterator<std::random_access_iterator_tag,
 ...
 */
	...
	*/
	...
	friend RAPIDJSON_DISABLEIF_RETURN((internal::IsGenericValue<T>), (bool) ) operator==(
			const T &lhs, const GenericValue &rhs)
	{
		return rhs == lhs;
	}
	...
	*/
	...
	template <typename T>
	RAPIDJSON_DISABLEIF_RETURN(
			(internal::NotExpr<internal::IsSame<typename internal::RemoveConst<T>::Type, Ch>>), (const GenericValue &) )
	...
	GenericValue &Reserve(SizeType newCapacity, Allocator &allocator)
	{
		...
		if (newCapacity > data_.a.capacity) {
			SetElementsPointer(reinterpret_cast<GenericValue *>(allocator.Realloc(GetElementsPointer(),
					data_.a.capacity * sizeof(GenericValue), newCapacity * sizeof(GenericValue))));
...
class GenericDocument : public GenericValue<Encoding, Allocator>
{
  public:
	...
	*/
	GenericDocument(
			Allocator *allocator = 0, size_t stackCapacity = kDefaultStackCapacity, StackAllocator *stackAllocator = 0)
...
template <bool Const, typename ValueT> class GenericArray
{
  public:
	...
	template <typename T>
	RAPIDJSON_DISABLEIF_RETURN(
			(internal::OrExpr<internal::IsPointer<T>, internal::IsGenericValue<T>>), (const GenericArray &) )
