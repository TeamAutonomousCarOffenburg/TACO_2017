...
class RfcnBoxPredictor(BoxPredictor):
  ...
  """
    ...
    def __init__(self, is_training, num_classes, conv_hyperparams,
                 num_spatial_bins, depth, crop_size, box_code_size):
        """Constructor.
    ...
    """
        ...
        with slim.arg_scope(self._conv_hyperparams):
            ...
            location_feature_map_depth = (
                self._num_spatial_bins[0] * self._num_spatial_bins[1] *
                self.num_classes * self._box_code_size)
            location_feature_map = slim.conv2d(
                net,
                location_feature_map_depth, [1, 1],
                activation_fn=None,
            ...
            class_feature_map_depth = (self._num_spatial_bins[
                0] * self._num_spatial_bins[1] * total_classes)
            class_feature_map = slim.conv2d(
                net,
  ...
  """
    ...
    """
        ...
        if ((self._predict_instance_masks or self._predict_keypoints)
                and self._conv_hyperparams is None):
            raise ValueError(
    ...
    """
        ...
        spatial_averaged_image_features = tf.reduce_mean(
            image_features, [1, 2], keep_dims=True, name='AvgPool')
        flattened_image_features = slim.flatten(
