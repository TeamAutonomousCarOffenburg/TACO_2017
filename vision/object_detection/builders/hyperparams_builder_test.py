...
class HyperparamsBuilderTest(tf.test.TestCase):
    ...
    """
        ...
        scope = hyperparams_builder.build(
            conv_hyperparams_proto, is_training=True)
    ...
    """
        ...
        text_format.Merge(conv_hyperparams_text_proto, conv_hyperparams_proto)
        scope = hyperparams_builder.build(
            conv_hyperparams_proto, is_training=False)
        conv_scope_arguments = scope.values()[0]
        self.assertEqual(conv_scope_arguments['normalizer_fn'],
                         slim.batch_norm)
        batch_norm_params = conv_scope_arguments['normalizer_params']
    ...
    """
        ...
        self._assert_variance_in_range(
            initializer, shape=[100, 40], variance=2. / 100.)
    ...
    """
        ...
        initializer = conv_scope_arguments['weights_initializer']
        self._assert_variance_in_range(
            initializer, shape=[100, 40], variance=2. / 40.)
    ...
    """
        ...
        initializer = conv_scope_arguments['weights_initializer']
        self._assert_variance_in_range(
            initializer, shape=[100, 40], variance=4. / (100. + 40.))
    ...
    """
        ...
        initializer = conv_scope_arguments['weights_initializer']
        self._assert_variance_in_range(
            initializer, shape=[100, 40], variance=0.49, tol=1e-1)
