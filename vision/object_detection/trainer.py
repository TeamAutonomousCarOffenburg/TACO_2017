...
def _create_losses(input_queue, create_model_fn):
  ...
  """
    ...
    (images, groundtruth_boxes_list,
     groundtruth_classes_list, groundtruth_masks_list) = _get_inputs(
  ...
  """
    ...
    with tf.Graph().as_default():
        ...
        model_fn = functools.partial(
            _create_losses, create_model_fn=create_model_fn)
