...
_FASTERRCNN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='first_stage_only',
            full_name='object_detection.protos.FasterRcnn.first_stage_only',
            index=0,
            number=1,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_anchor_generator',
            full_name=
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_box_predictor_conv_hyperparams',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_box_predictor_kernel_size',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_box_predictor_depth',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_minibatch_size',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_positive_balance_fraction',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_nms_score_threshold',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_nms_iou_threshold',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_max_proposals',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_localization_loss_weight',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_objectness_loss_weight',
            full_name=
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='second_stage_box_predictor',
            full_name=
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='second_stage_balance_fraction',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='second_stage_post_processing',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='second_stage_localization_loss_weight',
            full_name=
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='second_stage_classification_loss_weight',
            full_name=
...
_FASTERRCNNFEATUREEXTRACTOR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='first_stage_features_stride',
            full_name=
...
_FASTERRCNN.fields_by_name[
    'image_resizer'].message_type = object_detection.protos.image_resizer_pb2._IMAGERESIZER
_FASTERRCNN.fields_by_name[
    'feature_extractor'].message_type = _FASTERRCNNFEATUREEXTRACTOR
_FASTERRCNN.fields_by_name[
    'first_stage_anchor_generator'].message_type = object_detection.protos.anchor_generator_pb2._ANCHORGENERATOR
_FASTERRCNN.fields_by_name[
    'first_stage_box_predictor_conv_hyperparams'].message_type = object_detection.protos.hyperparams_pb2._HYPERPARAMS
_FASTERRCNN.fields_by_name[
    'second_stage_box_predictor'].message_type = object_detection.protos.box_predictor_pb2._BOXPREDICTOR
_FASTERRCNN.fields_by_name[
    'second_stage_post_processing'].message_type = object_detection.protos.post_processing_pb2._POSTPROCESSING
_FASTERRCNN.fields_by_name[
    'hard_example_miner'].message_type = object_detection.protos.losses_pb2._HARDEXAMPLEMINER
DESCRIPTOR.message_types_by_name['FasterRcnn'] = _FASTERRCNN
DESCRIPTOR.message_types_by_name[
    'FasterRcnnFeatureExtractor'] = _FASTERRCNNFEATUREEXTRACTOR

FasterRcnn = _reflection.GeneratedProtocolMessageType(
    'FasterRcnn',
    (_message.Message, ),
    dict(
...
FasterRcnnFeatureExtractor = _reflection.GeneratedProtocolMessageType(
