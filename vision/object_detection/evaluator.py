...
def _extract_prediction_tensors(model,
  ...
  """
    ...
    tensor_dict = {
        ...
        'detection_classes': (tf.squeeze(
            detections['detection_classes'], axis=0) + label_id_offset),
    }
...
def evaluate(create_input_dict_fn, create_model_fn, eval_config, categories,
  ...
  """
    ...
    def _process_aggregated_results(result_lists):
        ...
        return EVAL_METRICS_FN_DICT[eval_metric_fn_key](
            result_lists, categories=categories)
