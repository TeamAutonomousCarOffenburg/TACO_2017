...
public class Angle implements Serializable
{
	...
	{
		return VectorUtils.to2D(rotate(position.getX(), position.getY(), angle));
	}
	 ...
	 * @return the rotated position
	 */
	public Vector3D applyTo(double x, double y)
	{
	 ...
	 * @return the inversely rotated position
	 */
	public Vector3D applyInverseTo(double x, double y)
	{
		return rotate(x, y, -angle);
	}
	 ...
	 * @return the rotated position
	 */
	private Vector3D rotate(double x, double y, double angleRad)
	{
